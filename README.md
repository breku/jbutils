...
- jbcity-courses-addon: addon module, custom server and client side code 
- jbcity-courses-ui: main application module
- jbcity-courses-backend: backend module, contains any server side java code and dependencies
